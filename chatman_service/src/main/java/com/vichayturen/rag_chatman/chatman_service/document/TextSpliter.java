...
import com.vichayturen.rag_chatman.chatman_service.constant.SplitConstant;
import lombok.Data;
...
public class TextSpliter {
    ...
    public static List<String> split(String text) {
        TextSpliter textSpliter = TextSpliter.builder()
                .chunkSize(SplitConstant.DEFAULT_CHUNK_SIZE)
                .chunkOverlap(SplitConstant.DEFAULT_CHUNK_OVERLAP)
                .build();
    ...
    public static class Builder {
        ...
        public Builder separators(List<String> separators) {this.separators = separators; return this;}
        public Builder stripWhitespace(boolean stripWhitespace) {this.stripWhitespace = stripWhitespace; return this;}
